...
print("Neighbors_Accuracy = ", kn.score(fish_data, fish_target))
print("Test sample_구분 =", kn.predict([[30, 600]]))

kn49 = KNeighborsClassifier(n_neighbors=49)
kn49.fit(fish_data, fish_target)
print("n=49 data_Accuracy = ", kn49.score(fish_data, fish_target))
